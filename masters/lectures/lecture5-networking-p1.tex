...
\begin{frame}
  ...
  \begin{center}
  \includegraphics[scale=0.5]{network-cpu-ddio-nic.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{network-memory-flow.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{network-mbufs.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[scale=0.4]{network-in-out.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[scale=0.4]{network-forward.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{network-dispatch-input.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{network-dispatch-output.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{network-dispatch-toe.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \column{0.45\textwidth}
      ...
      \smallskip
      \includegraphics[width=1.1\textwidth]{network-nic-stack.pdf}

      \bigskip
      \includegraphics[width=1.1\textwidth]{network-netmap-memory-flow.pdf}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \smallskip
    \includegraphics[scale=0.61]{throughput_nginx_sandstorm_6nics_new.pdf} \\
    \includegraphics[scale=0.61]{cpu_nginx_sandstorm_6nics_new.pdf}
